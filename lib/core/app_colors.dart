...
class AppColors {
  ...
  static final Color lightGrey = Color(0xFF8b8b8b);
  ...
  static final Color backPrimary = Color(0xFF303030);
  static final Color blackSecondary = Color(0xFF2a2a2a);
  static final Color lightBack = Color(0xFF404040);
}
